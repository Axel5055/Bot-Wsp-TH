...
module.exports = {
  ...
  execute: async (sock, msg) => {
    const imagePath = path.join(
      __dirname,
      '../../../media/images/armaduras/cab.jpeg'
    )
    ...
    try {
      ...
      if (!fs.existsSync(imagePath)) {
        ...
        await sock.sendMessage(msg.key.remoteJid, {
          text: '⚠️ Error: la imagen del set de caballería no está disponible.'
        })
      ...
      await sock.sendMessage(msg.key.remoteJid, {
        image: { url: imagePath },
        caption: `🐎 *SET DE CABALLERÍA RECOMENDADO* 🐎

¡Equipar este set te dará una ventaja significativa!
